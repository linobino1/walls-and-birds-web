...
export default function Legal() {
  return (
    <Layout type="white" style={{ padding: "1em" }}>
      <h1>Imprint</h1>
      ...
      <p>
        ...
        are not obliged to monitor transmitted or stored third-party information
      ...
      <p>
        ...
        of which we have no influence on. Therefore we cannot assume any
        liability for this external content. The respective provider or operator
        ...
        become aware of legal violations, we will remove such links immediately.
      </p>
      <p>
      ...
      <p>
        ...
        copyrights of third parties are observed. In particular contents of
        third parties are marked as such. Should you nevertheless become aware
        of a copyright infringement, we ask that you inform us accordingly. As
        soon as we become aware of legal violations, we will remove such content
        immediately.
      </p>
    </Layout>
  );
